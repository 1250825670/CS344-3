...
int main(int argc, char *argv[])
{
	...
	if (ciphertextFD < 0) error("CLIENT: ERROR plaintext file open failed");
	...
	charsRead = read(ciphertextFD,textBuffer,sizeof(textBuffer)-1);	//get the plaintext information
	...
	strcpy(buffer, "otp_dec");	//send program name to check access
